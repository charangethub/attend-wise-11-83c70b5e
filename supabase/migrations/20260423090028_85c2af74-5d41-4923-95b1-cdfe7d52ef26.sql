CREATE OR REPLACE FUNCTION public.normalize_inventory_grade_bucket(_grade text)
RETURNS text
LANGUAGE plpgsql
IMMUTABLE
...
BEGIN
  ...
  SELECT public.normalize_inventory_grade_bucket(s.grade)
...
CREATE TRIGGER sync_inventory_on_distribution_trigger
