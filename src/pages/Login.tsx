...
const Login = () => {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background p-4">
      <SEO
        title="Sign In — Vedantu Attendance"
        description="Sign in to the Vedantu Attendance Management System to mark attendance, manage absentees, exams, inventory, and distribution."
        path="/login"
      />
      <h1 className="sr-only">Sign in to Vedantu Attendance</h1>
